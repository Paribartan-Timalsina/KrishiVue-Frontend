...
//     // TensorBuffers for output tensors
//     TensorBuffer outputLocations = TensorBufferFloat(_outputShapes![0]);//1

//     TensorBuffer outputClasses = TensorBufferFloat(_outputShapes![1]);//0
    
//     TensorBuffer outputScores = TensorBufferFloat(_outputShapes![2]);//3
//     print("Hello,${outputScores.getDoubleValue(2)}");
//     TensorBuffer numLocations = TensorBufferFloat(_outputShapes![3]);//2
// print('The numlocations is: ${numLocations.getIntValue(0)}');
//     // Inputs object for runForMultipleInputs
//     // Use [TensorImage.buffer] or [TensorBuffer.buffer] to pass by reference
//     List<Object> inputs = [inputImage.buffer];
