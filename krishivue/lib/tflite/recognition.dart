...
class Recognition {
  ...
  /// Location of the bounding box rect
  ///
  /// The rectangle corresponds to the raw input image
  /// passed for inference
  Rect? _location;
  ...
  ///
  /// This is the actual location where the rectangle is rendered on
  /// the screen
  Rect get renderLocation {
    if (location == null) {
    ...
    // ratioX = screenWidth / imageInputWidth
    // ratioY = ratioX if the image fits screenWidth with aspectRatio = constant

    double ratioX = CameraViewSingleton.ratio ?? 1.0;
    double ratioY = ratioX;
